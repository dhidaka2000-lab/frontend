<template>
  <main role="main" class="container py-3">
    ...
    <div class="text-center my-4">
      <h2><i class="fas fa-user-cog"></i> マイ設定</h2>
    </div>

    <div class="row">
      <div class="col-sm-2"></div>
      <div class="col-sm-8">
        <button class="btn alert-primary col-12 text-left mb-3" @click="router.push({ name: 'changePassword' })">
          <h5 class="mb-0"><i class="fas fa-key"></i> パスワード変更</h5>
        </button>
      </div>
      <div class="col-sm-2"></div>
    </div>
